...
<p style="font-size: 0.9em; background-color: white; color: grey; padding: 10px;">Tasso di crescita del Numero di Candidati nei Cluster individuati</p>
...
<div style="width: 100%; display: flex; justify-content: center; align-items: center;">
  <div style="width: 120%; margin-left: 0%;">
    <div style="display: flex; justify-content: center; align-items: center; flex-direction: column;">
      <div style="flex: 1; max-width: 180%;"><vegachart schema-url="{{site.baseurl}}/assets/charts/GiulioArt3FACOLTATIVO_Skills_v2.json"></vegachart></div>
    </div>
  </div>
</div>
